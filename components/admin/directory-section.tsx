...
/** Event-year picker + directory editor — same year UX as the other admin pages. */
export function DirectorySection({ canManage }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div className="max-w-xs">
        <Label htmlFor="directory-year-picker">Event year</Label>
        <Select value={String(eventYear)} onValueChange={handleYearChange}>
          <SelectTrigger id="directory-year-picker" className="min-h-11">
      ...
      <DirectoryManager canManage={canManage} eventYear={eventYear} />
    </div>
  )
}
