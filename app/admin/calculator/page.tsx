...
import { AdminCalculatorClient } from "./calculator-client"
...
export default async function AdminCalculatorPage() {
      ...
      <div className="min-h-screen bg-muted/30 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Please sign in to access the admin calculator.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center">
            <Button asChild>
              <Link href="/sign-in?redirect_url=/admin/calculator">Sign In</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  // Only admins can use the calculator
  if (admin.role !== "admin") {
    return (
        ...
        <main id="main-content" className="container py-8">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Only administrators can access the rate calculator.
              </CardDescription>
            </CardHeader>
          </Card>
        </main>
