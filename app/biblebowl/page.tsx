      ...
      <main className="flex-1">
        <div className="container mx-auto px-6 py-16 text-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground">
            <div>The Bible Bowl will be open to anyone who wants to participate (from toddlers - adult).</div>
            <div>
              <br />
            </div>
            <div>For 2026, our lessons &amp; memory work will be from the books of Galatians &amp; Ephesians.</div>
            <div>
              <br />
            </div>
            <div>There will be 3 levels of the test available covering the chapter summaries above:</div>
            <div>
              (1) a blank sheet of paper to be filled out, (2) a matching page, or (3) a verbal quiz for those unable to
              write. It will not be a
            </div>
            <div>
              competition but an individual testing of whether you have mastered the selected memory work above. We are
